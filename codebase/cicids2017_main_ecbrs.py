...
if __name__ == "__main__":
    ...
    parser.add_argument('--ds', type=str, default="cicids2017_ecbrs", metavar='S',help='dataset name')
    ...
    for seed_value in seed_list:
        ...
        proc = subprocess.Popen(["python cicids2017_ecbrs.py --seed="+str(seed_value)+" --gpu="+str(args.gpu)+" --filename="+str(temp_file_name)],shell=True,cwd=curr_dir)
        proc.communicate()
