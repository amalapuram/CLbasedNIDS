...
def retrieve_MIR_samples(Xt, yt,class_imbalance_aware_sample_selection):
    global batch_size,total_interfered_samples,VPU_sgd_operations,param_weights_container_Reg_SGD,param_weights_container_vpu_SGD,bool_store_weights,param_diff_list
...
def evaluate_on_testset():
    ...
    for idx in range(0,X_test.shape[0],250):
        idx1=idx
        idx2 = idx1+250
...
def taskwise_lazytrain():
    global test_x,test_y,task_num,flops_count,param_diff_list,otdd_list
