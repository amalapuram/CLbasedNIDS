...
if __name__ == "__main__":
    ...
    parser.add_argument('--ds', type=str, default="cicids2017", metavar='S',help='dataset name')
    ...
    parser.add_argument('--cls', type=int, default=0, metavar='S',help='cl strategy')
    ...
    for seed_value in seed_list:
        ...
        proc = subprocess.Popen(["python cicids2017_avalanche.py --seed="+str(seed_value)+" --gpu="+str(args.gpu)+" --cls="+str(args.cls)+" --filename="+str(temp_file_name)],shell=True,cwd=curr_dir)
        proc.communicate()
