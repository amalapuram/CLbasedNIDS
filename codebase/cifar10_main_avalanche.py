...
if __name__ == "__main__":
    ...
    parser.add_argument('--ds', type=str, default="cifar10", metavar='S',help='dataset name')
    ...
    for seed_value in seed_list:
        ...
        proc = subprocess.Popen(["python cifar10_avalanche.py --seed="+str(seed_value)+" --gpu="+str(args.gpu)+" --cls="+str(args.cls)+" --filename="+str(temp_file_name)],shell=True,cwd=curr_dir)
        proc.communicate()
