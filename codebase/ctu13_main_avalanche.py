...
if __name__ == "__main__":
    ...
    for seed_value in seed_list:
        ...
        proc = subprocess.Popen(["python ctu13_avalanche.py --seed="+str(seed_value)+" --gpu="+str(args.gpu)+" --cls="+str(args.cls)+" --filename="+str(temp_file_name)],shell=True,cwd=curr_dir)
        proc.communicate()
