...
if __name__ == "__main__":
    ...
    parser.add_argument('--ds', type=str, default="kddcup99_mir", metavar='S',help='dataset name')
    ...
    for seed_value in seed_list:
        ...
        proc = subprocess.Popen(["python kddcup99_MIR.py --seed="+str(seed_value)+" --gpu="+str(args.gpu)+" --filename="+str(temp_file_name)],shell=True,cwd=curr_dir)
        proc.communicate()
