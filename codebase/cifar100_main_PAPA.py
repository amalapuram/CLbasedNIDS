...
if __name__ == "__main__":
    ...
    for seed_value in seed_list:
        ...
        proc = subprocess.Popen(["python cifar10_PAPA.py --seed="+str(seed_value)+" --gpu="+str(args.gpu)+" --filename="+str(temp_file_name)],shell=True,cwd=curr_dir)
        proc.communicate()
    ...
    print("*"*80)    
    print("{:<20}  {:<20}  {:<20}  {:<20}  {:<20}  {:<20}  {:<20}  {:<20}".format('seed','PR-AUC(O)', 'PR-AUC(I)', 'ROC-AUC','Total train time','Total MIR time','Regular sgd operations','virtual SGD ops'))
    print("*"*80)
